...
/**
 * Program to getByUsername System Motherboard Serial Number for Windows and Linux Machine
 * @author includehelp
 */
public class MotherboardSerialNumber {

    /**
     * Method for getByUsername System Motherboard Serial Number
     * @return  MAC Address
     */
    ...
    /**
     * Method for getByUsername Windows Machine MotherBoard Serial Number
     * @return
     */
    ...
    /**
     * Method for getByUsername Linux Machine MotherBoard Serial Number
     * @return
     */
    ...
    public static boolean checkStartUp(String motherboardSerialNumber) {
     return getSystemMotherBoard_SerialNumber().equals(motherboardSerialNumber);
    }
}